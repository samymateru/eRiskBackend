...
async def create_new_risk_register(
    ...
    with exception_response():
        await add_new_risk_register(connection=connection, register=register, module_id=module_id, user_id=user_id)
        return CreateResponse(detail="Successfully create Register")
